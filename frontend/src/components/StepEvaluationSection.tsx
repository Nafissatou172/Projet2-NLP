...
import { ProcessType, StepScore } from '../types';
import { stepScoresData } from '../data/mockData';
...
const colors = ['#10b981', '#059669', '#047857', '#065f46', '#064e3b', '#0d3b2f'];

export const StepEvaluationSection: React.FC<StepEvaluationSectionProps> = ({ currentProcess }) => {
  const stepScores: StepScore[] = stepScoresData[currentProcess] || [];
    ...
    <div className="bg-white rounded-xl shadow-lg p-6 border border-green-100">
      ...
      {stepScores.length > 0 ? (
        ...
        <div className="h-96 flex flex-col items-center justify-center bg-gradient-to-b from-gray-50 to-white rounded-lg border-2 border-dashed border-green-200">
          ...
          <p className="text-gray-500 font-medium">Aucune donnée d'évaluation disponible pour ce processus</p>
        </div>
      )}
    </div>
  );
